...
export default function HomePage() {
  ...
  const handleLogout = async () => {
    if (!confirm("¿Cerrar sesión del CRM?")) return;
    try {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-medium text-neutral-600 bg-neutral-50 hover:bg-neutral-100 rounded-md border border-neutral-200 transition"
