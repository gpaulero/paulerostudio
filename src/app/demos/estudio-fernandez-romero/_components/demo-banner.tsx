export default function LawDemoBanner() {
  return (
    <div
    ...
    >
      ...
      <a
        href="https://wa.me/5493517656918?text=Hola%20Gonzalo%2C%20vi%20el%20demo%20de%20estudio%20y%20quiero%20algo%20parecido"
        className="underline font-medium"
        style={{ color: "#FFFFFF" }}
        target="_blank"
